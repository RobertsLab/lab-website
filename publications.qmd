...
Below you will find links to research papers. Recent papers can be searched by sorting and/or using filter function. Filter function works on author and title. Recent papers can also be identified by categories. See the table of contents at the right to jump to book chapters, preprints, theses, notebooks, and recent presentations. Search the entire website using the search icon in top right menu.
...
| Shelly Wanamaker          | [shellytrigg.github.io/notebook](https://shellytrigg.github.io/notebook/)   | [![GitHub followers](https://img.shields.io/github/followers/shellytrigg.svg?style=social&label=Follow&maxAge=2592000)](https://github.com/shellytrigg)     |
